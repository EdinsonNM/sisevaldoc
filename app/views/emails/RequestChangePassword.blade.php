    ...
    <td>
      ...
      <table cellspacing="0" cellpadding="0" border="0" style="margin-top:18px;margin-right:0;margin-bottom:18px;margin-left:0">
        <tbody><tr>
          ...
          <a href="{{ URL::to('/#cambiarpassword/'.$resetCode, array(), false)}}" style="color:#ffffff;text-decoration:none;font-size:16px;text-align:center;vertical-align:baseline;font-weight:normal" target="_blank">
